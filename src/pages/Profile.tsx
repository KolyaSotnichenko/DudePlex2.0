...
const Profile: FunctionComponent<ProfileProps> = () => {
  ...
  const changeEmail = () => {
    ...
    if (!emailValue.trim().length) {
      toast.error("Ви повинні щось набрати", {
        position: "top-right",
        autoClose: 2000,
        hideProgressBar: false,
        closeOnClick: true,
      ...
      {isShowPromptReAuthFor && (
        <>
          ...
          >
            ...
            Введіть пароль ще раз для повторної автентифікації
            </p>
            <input
        ...
        <div className="flex-grow pt-7 md:pl-10 px-3">
          ...
          <div className="flex flex-col-reverse md:flex-row gap-8 md:gap-0 ">
            <div className="flex-grow">
              ...
              <p>Тут ви можете редагувати публічну інформацію про себе.</p>
              <p>
              Якщо ви ввійшли за допомогою Google або Facebook, ви не можете змінити свою
                 електронну адресу та пароль.
              </p>
