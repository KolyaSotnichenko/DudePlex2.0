...
const FilmDetail: FC<FilmInfo> = ({ similar, videos, detail, ...others }) => {
  ...
  const bookmarkedHandler = async () => {
    ...
    if (!currentUser) {
      toast.error("Вам потрібно увійти, щоб додати фільми в закладки", {
        position: "top-right",
        autoClose: 2000,
        hideProgressBar: false,
        closeOnClick: true,
    ...
    toast.success(
      `${
        !isBookmarked
          ? "Зараз цей фільм додано в закладки"
          : "Цей фільм видалено з ваших закладок"
      }`,
      {
        position: "top-right",
        autoClose: 2000,
                  ...
                  <div className="flex gap-5 items-center">
                    ...
                    {isMobile && (
                      ...
                      >
                        ...
                        <span className="text-lg font-medium">ДИВИТИСЯ</span>
                      </Link>
                    )}
                  </div>
            ...
            {!isMobile && (
              <div className="shrink-0 md:max-w-[150px] w-full flex items-center md:flex-col justify-center flex-row gap-20 mt-20 md:border-r border-dark-lighten pt-16">
                <div className="flex flex-col gap-6 items-center">
                  <p className="text-white font-medium text-lg">РЕЙТИНГ</p>
                  {!isMobile && (
                    <div className="w-16">
                      {detail && (
                        <CircularProgressbar
