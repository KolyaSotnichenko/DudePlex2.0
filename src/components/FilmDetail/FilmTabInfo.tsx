      ...
      <div className="mt-10 text-lg">
        {currentTab === "overall" && (
          <>
            ...
            <p className="text-white font-medium mt-8 mb-3">ДЕТАЛІ</p>
            {!detail && (
              <>
            ...
            {detail && (
              <>
                ...
                {detail.media_type === "movie" && (
                  <p>Дата випуску: {(detail as DetailMovie).release_date}</p>
                )}
                {detail.media_type === "tv" && (
                  <p>Остання дата ефіру: {(detail as DetailTV).last_air_date}</p>
                )}
                <p>
                Розмовна мова:
                ...
                <li key={cast.id} className="flex gap-3 items-center">
                  ...
                  <div className="flex-grow">
                    ...
                    <p className="text-white text-base">
                      <span className="italic">як</span> {cast.character}
                    </p>
                  </div>
                </li>
              ))}
        ...
        {currentTab === "seasons" && (
          <>
            <div className="flex justify-between mb-8">
              <p>Кількість сезонів: {(detail as DetailTV).number_of_seasons}</p>
              <p>Кількість епізодів: {(detail as DetailTV).number_of_episodes}</p>
            </div>
                  ...
                  <div className="flex gap-3 items-center">
                    ...
                    <div className="flex-grow">
                      <div className="mb-3 flex justify-between">
                        ...
                        <p>{season.episode_count} епізоди</p>
                      </div>
                      <ReadMore
                        limitTextLength={130}
