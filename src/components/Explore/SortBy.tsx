...
const SortBy: FunctionComponent<SortByProps> = () => {
  ...
  const options = [
    { value: "popularity.desc", label: "Найбільш популярний" },
    { value: "vote_average.desc", label: "Найбільший рейтинг" },
    { value: "release_date.desc", label: "Найновіший" },
  ];
  ...
  return (
    ...
    >
      <div className="flex justify-between items-center text-white pb-3">
        <p className="text-lg ">Сортувати</p>
      ...
      {openSort && (
        <div className="py-3 border-t border-dark-darken">
          <p className="text-lg mb-2 text-white/80">Сортувати результати за </p>
          <Select
            options={options}
            styles={customStyles}
            // defaultValue={}
