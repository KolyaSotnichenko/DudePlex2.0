      ...
      {isVerificationEmailSent && (
        <>
          <div className="px-5 py-3 rounded-md z-10 bg-dark-lighten-2 md:w-[500px] fixed top-[35%] md:left-[35%] left-[5%] right-[5%] min-h-[150px]">
            ...
            Ми надіслали електронний лист для підтвердження на вашу електронну адресу,
              <span className="text-primary"> {currentUser?.email}</span>. Перевірте!
            </p>
            <button
      ...
      <div className="mt-10 flex justify-between max-w-[600px]">
        <p className="text-white text-lg">
          {!currentUser?.emailVerified
            ...
            : "Ваша електронна пошта підтверджена."}
        </p>
        {isShowSentButton && (
          <button
          ...
          >
            Надішліть мені електронний лист для підтвердження
          </button>
        )}
        {!isShowSentButton && <p className="text-lg ">Чекаю підтвердження</p>}
      </div>
    </>
  );
};
